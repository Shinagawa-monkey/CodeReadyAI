...
export function generateAiQuestion({ jobInfo, previousQuestions, difficulty, onFinish }: {
  jobInfo: Pick<typeof JobInfoTable.$inferSelect, "title" | "description" | "experienceLevel">, previousQuestions: Pick<typeof QuestionTable.$inferSelect,
    "text" | "difficulty">[], difficulty: QuestionDifficulty, onFinish: (question: string) => void
}) {
